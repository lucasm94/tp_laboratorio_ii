...
namespace FrmHinchaPlus
{
    public partial class FrmCargarHincha : Form
    {
        ...
        public event DelegadoHinchaPlus EventoActualizarEstadisticas;

        public FrmCargarHincha(HinchaPlusServicio hinchaPlus, Button bajaMenu, Button actualizarMenu)
        {
        ...
        private void btnCargar_Click(object sender, EventArgs e)
        {
            ...
            } else
            {
                try
                {
                    ...
                    if (this.hinchaPlus.HinchasActivos() > 0)
                    {
                        this.bajaMenu.Enabled = true;
                        this.actualizarMenu.Enabled = true;
                    }
                    this.Clear();
                    EventoActualizarEstadisticas.Invoke();
                    this.Close();
                }
